...
class TwoPassMasteringEngine:
    ...
    def measure_loudness(self, audio_data: np.ndarray, sample_rate: int) -> Dict[str, float]:
    ...
    def process_mastering(self, audio_data: np.ndarray, sample_rate: int, preset: Dict[str, Any]) -> Tuple[np.ndarray, Dict[str, Any]]:
