...
down_revision: Union[str, Sequence[str], None] = "20260902_03"
...
def upgrade() -> None:
    with op.batch_alter_table("upload_sessions") as batch_op:
        batch_op.add_column(sa.Column("offset", sa.BigInteger(), nullable=False, server_default="0"))
        batch_op.add_column(
            sa.Column(
                "content_type",
        ...
        batch_op.add_column(sa.Column("quarantine_key", sa.String(length=512), nullable=True))
