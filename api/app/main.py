...
from api.app.api.v1 import broadcast, compositor, export, health, jobs, mastering, mixes, sidechain, stems, uploads
...
app.include_router(export.router, prefix=f"{settings.api_v1_prefix}/mixes", tags=["export"])
...
app.include_router(compositor.router, prefix=settings.api_v1_prefix, tags=["compositor"])
